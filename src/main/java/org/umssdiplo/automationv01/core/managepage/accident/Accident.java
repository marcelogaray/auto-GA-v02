...
public class Accident extends BasePage {
    private static final String DESCRIPTION_COLUMN_CLASS_NAME = "description-column";
    ...
    public String getDescription(int position) {
        WebElement descriptionColumn = CommonEvents.getWebElementByClassName(accidents.get(position), DESCRIPTION_COLUMN_CLASS_NAME);
